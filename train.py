...
from models.Networks import (base, base_PGAM, base_PGAM1, base_PGAM2, base_AEMF, base_AEMF1, base_AEMF2, base_AEMF3,
                             base_DME, base_DME1, base_DME2, base_DME3, base_all2, base_all3, base_all4, DENet, DENet_s, DENet_l)
        ...
        for step, batch_data in enumerate(loader):
            ...
            if is_mixed:
                with torch.amp.autocast('cuda'):
                    outputs = model(inputs_t1, inputs_t1ce, inputs_t2, inputs_flair)
